<div class="header-top">
    <div class="container">
        <div class="header-left header-dropdowns">
            ...
            <div class="header-dropdown">
                <a href="#"><img src="http://localhost:82/wordpress/wp-content/themes/porto/images/flags/en.png"
                        alt="England flag">ENGLISH</a>
                <div class="header-menu">
                    <ul>
                        <li><a href="#"><img
                                    src="http://localhost:82/wordpress/wp-content/themes/porto/images/flags/en.png"
                                    alt="England flag">ENGLISH</a>
                        </li>
                        <li><a href="#"><img
                                    src="http://localhost:82/wordpress/wp-content/themes/porto/images/flags/fr.png"
...
<div class="typr-212">
    <div class="wrapper">
        ...
        <label for="modal" class="label-show-modal">| LOGIN</label>
        <div class="modal-show">
            <div class="modal-show-inner">
                <label class="cancel" for="modal">✖</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="#" class="mb-1">
                                        ...
                                        <input type="email" class="form-input form-wide mb-2" id="login-email"
                                            required="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="#">
                                        ...
                                        <input type="email" class="form-input form-wide mb-2" id="register-email"
                                            required="">

                                        <label for="register-password">Password <span class="required">*</span></label>
                                        <input type="password" class="form-input form-wide mb-2" id="register-password"
                                            required="">
