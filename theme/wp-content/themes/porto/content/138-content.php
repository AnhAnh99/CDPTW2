        ...
        <nav aria-label="breadcrumb" class="breadcrumb-nav">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-chevron-right"></i>Headsets
                    </li>
                </ol>
            </div><!-- End .container -->
        </nav>
                    ...
                    <div class="swiper-container gallery-top swiper-container-initialized swiper-container-horizontal">
                        <div class="swiper-wrapper"
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev"
                                data-swiper-slide-index="0" style="width: 458px; margin-right: 10px;">
                                <div class="swiper-zoom-container">
                                    <img class="product-single-image" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-1.jpg"
                                        data-zoom-image="<?php bloginfo('template_url'); ?>/images/products/zoom/product-1-big.jpg">
                                </div>
                            </div>
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                                data-swiper-slide-index="1" style="width: 458px; margin-right: 10px;">
                                <div class="swiper-zoom-container">
                                    <img class="product-single-image" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-2.jpg">
                                </div>
                            </div>
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next"
                                data-swiper-slide-index="2" style="width: 458px; margin-right: 10px;">
                                <div class="swiper-zoom-container">
                                    <img class="product-single-image" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-3.jpg"
                                        data-zoom-image="<?php bloginfo('template_url'); ?>/images/products/zoom/product-3-big.jpg">
                                </div>
                            </div>
                            <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3"
                                style="width: 458px; margin-right: 10px;">
                                <div class="swiper-zoom-container">
                                    <img class="product-single-image" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-4.jpg"
                                        data-zoom-image="<?php bloginfo('template_url'); ?>/images/products/zoom/product-4-big.jpg">
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div class="swiper-wrapper prod-thumbnail"
                            ...
                            <div class="swiper-slide active swiper-slide-visible swiper-slide-active"
                                ...
                                <img class="slide " src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-1.jpg">
                            </div>
                            <div class="swiper-slide swiper-slide-visible swiper-slide-next swiper-slide-thumb-active"
                                style="width: 107px; margin-right: 10px;">
                                <img class="slide" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-2.jpg">
                            </div>
                            <div class="swiper-slide swiper-slide-visible" style="width: 107px; margin-right: 10px;">
                                <img class="slide" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-3.jpg">
                            </div>
                            <div class="swiper-slide swiper-slide-visible" style="width: 107px; margin-right: 10px;">
                                <img class="slide" src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-4.jpg">
                            </div>
                        </div>
                        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6">
                        ...
                        <div class="product-single-tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active show" id="product-tab-desc" data-toggle="tab"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="product-desc-content" role="tabpanel"
