                    ...
                    <div class="header-top">
                        <div class="container">
                            <div class="header-left header-dropdowns">
                                ...
                                <div class="header-dropdown">
                                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/images/flags/en.png" alt="England flag">ENGLISH</a>
                                    <div class="header-menu">
                                        <ul>
                                            <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/images/flags/en.png" alt="England flag">ENGLISH</a>
                                            </li>
                                            <li><a href="#"><img src="<?php bloginfo('template_url'); ?>/images/flags/fr.png" alt="France flag">FRENCH</a></li>
                                        </ul>
                                    </div><!-- End .header-menu -->
                                </div><!-- End .header-dropown -->
                                        ...
                                        <div class="dropdownmenu-wrapper">
                                            <ul class="compare-products">
                                                ...
                                                <li class="product">
                                                    <a href="#" class="btn-remove" title="Remove Product"><i
                                                                class="icon-cancel"></i></a>
                                                    <h4 class="product-title"><a href="product.html">Blue Women Shirt</a>
                                                    </h4>
                                                </li>
                                            </ul>
                            ...
                            <div class="header-right right-top">
                        ...
                        <div class="container">
                            <div class="header-left">
                                <a href="index.html" class="logo">
                                    <img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="Porto Logo">
                                </a>
                            </div><!-- End .header-left -->
                                        ...
                                        <div class="dropdownmenu-wrapper">
                                            <div class="dropdown-cart-products">
                                                <div class="product">
                                                    ...
                                                    <figure class="product-image-container">
                                                        <a href="product.html" class="product-image">
                                                            <img src="<?php bloginfo('template_url'); ?>/images/products/cart/product-1.jpg" alt="product">
                                                        </a>
                                                        <a href="#" class="btn-remove" title="Remove Product"><i
                                                                    class="icon-cancel"></i></a>
                                                    </figure>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <figure class="product-image-container">
                                                        <a href="product.html" class="product-image">
                                                            <img src="<?php bloginfo('template_url'); ?>/images/products/cart/product-2.jpg" alt="product">
                                                        </a>
                                                        <a href="#" class="btn-remove" title="Remove Product"><i
                                                                    class="icon-cancel"></i></a>
                                                    </figure>
                                        ...
                                        <div class="megamenu megamenu-fixed-width">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="banner">
                                                        <a href="#">
                                                            <img src="<?php bloginfo('template_url'); ?>/images/menu-banner-2.jpg" alt="Menu banner">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-lg-4 -->
                                            </div>
                                        ...
                                        <div class="megamenu">
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="product-full-width.html">Vertical
                                                                        Thumbnails<span class="tip tip-hot">Hot!</span></a>
                                                                </li>
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="product-grid-layout.html">Grid <?php bloginfo('template_url'); ?>/images
                                                                        Layout</a>
                                                                </li>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="banner">
                                                        <a href="#">
                                                            <img class="product-promo" src="<?php bloginfo('template_url'); ?>/images/menu-banner.jpg"
                                                                 alt="Menu banner">
                                                        </a>
                                                    </div><!-- End .banner -->
                                                </div><!-- End .col-lg-4 -->
                        ...
                        <ul class="mobile-menu">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="category-6col.html">6 Columns Products</a></li>
                                    <li><a href="category-7col.html">7 Columns Products</a></li>
                                    <li><a href="ca'tegory-8col.html">8 Columns Products</a></li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="product-grid-layout.html">Grid <?php bloginfo('template_url'); ?>/images Layout</a></li>
