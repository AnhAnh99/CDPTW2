                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 product-single-gallery product-list">
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-1.jpg" data-zoom-image="images/products/zoom/product-1-big.jpg" alt="product name">
                            ...
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-2.jpg" data-zoom-image="images/products/zoom/product-2-big.jpg" alt="product name">
                                    <span class="prod-full-screen">
                                        <i class="icon-plus"></i>
                                    </span>
                                </div>
                            ...
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-3.jpg" data-zoom-image="images/products/zoom/product-3-big.jpg" alt="product name">
                                    <span class="prod-full-screen">
                                        <i class="icon-plus"></i>
                                    </span>
                                </div>
                            ...
                            <div class="product-item">
                                <div class="inner">
                                    <img src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-4.jpg" data-zoom-image="images/products/zoom/product-4-big.jpg" alt="product name">
                                    <span class="prod-full-screen">
                                        <i class="icon-plus"></i>
                                    </span>
                                </div>
