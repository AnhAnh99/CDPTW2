                ...
                <div class="row">
                    <div class="col-lg-9">
                                ...
                                <div class="col-lg-7 col-md-6 product-single-gallery">
                                    <div class="swiper-container gallery-top">
                                        <div class="swiper-wrapper ">
                                            <div class=" swiper-slide product-item active">
                                                <img class="product-single-image"
                                                    src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-1.jpg" />
                                            </div>
                                            <div class=" swiper-slide product-item">
                                                <img class="product-single-image"
                                                    src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-2.jpg" />
                                            </div>
                                            <div class="swiper-slide product-item">
                                                <img class="product-single-image"
                                                    src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-3.jpg" />
                                            </div>
                                            <div class="swiper-slide product-item">
                                                <img class="product-single-image"
                                                    src="<?php bloginfo('template_url'); ?>/images/products/zoom/product-4.jpg" />
                                            </div>
                                        </div>
                        ...
                        <div class="product-single-tabs scrolling-box">
                            ...
                            <?php get_template_part('content/342','content');?>
                            <?php get_template_part('content/343','content');?>
