<?php
    ...
    $less = new lessc;
    $less->compileFile('less/131.less', 'css/131.css');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/131.css" rel="stylesheet" type="text/css" />
...
<body>
    <?php include $dir_block.'/131-content.php'; ?>
