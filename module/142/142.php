<?php
    ...
    $less = new lessc;
    $less->compileFile('less/142.less', 'css/142.css');
...
<body>
    <?php include $dir_block.'/142-content.php'; ?>
    <script src="<?php echo $url_path?>/js/swiper.min.js"></script>
    <script src="<?php echo $url_path ?>/js/142.js"></script>
</body>
