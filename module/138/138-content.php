<div class="type-138">
    <div class="product-single-video" style="background-image: url('images/bg-4.jpg');">
        <div class="container">
            <h3>Concept Film</h3>
            <a href="#" class="video-btn">
                Watch <img src="images/icon-play.png" alt="play">
            </a>
        </div><!-- End .container -->
    </div>
            ...
            <div class="swiper-container">
                <!-- End .product -->
                    <div class="swiper-wrapper"
                        style="transform: translate3d(0px, 0px, 0px); transition: 0s; width: 1181px;">
                        <div class="swiper-slide" style="width: 225.2px; margin-right: 11px;">
                            <div class="product">
