<?php
    ...
    $less = new lessc;
    $less->compileFile('less/128.less', 'css/128.css');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/128.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo $url_path ?>/js/128.js"></script>
   
</head>

<body>
    <?php include $dir_block.'/128-content.php'; ?>
