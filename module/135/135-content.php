        ...
        <main class="main">
            ...
            <div class="row products-body">
                <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
                    <div class="pin-wrapper" style="height: 1359px;">
                        <div class="sidebar-wrapper sticky-active sticky-absolute sticky-transition"
                            style="border-bottom: 0px none rgb(122, 125, 130); width: 270px; position: absolute; top: 160.5px;">
                            <div class="widget">
                                                    ...
                                                    <div class="noUi-base">
                                                        <div class="noUi-connects">
                                                            <div class="noUi-connect"
                                                                style="transform: translate(20%, 0px) scale(0.5, 1);">
                                                            </div>
                                                        </div>
                                                        <div class="noUi-origin"
                                                            style="transform: translate(-80%, 0px); z-index: 5;">
                                                            <div class="noUi-handle noUi-handle-lower" data-handle="0"
                                                                tabindex="0" role="slider" aria-orientation="horizontal"
                                                                aria-valuemin="0.0" aria-valuemax="60.0"
                                                                aria-valuenow="20.0" aria-valuetext="200.00"></div>
                                                        </div>
                                                        <div class="noUi-origin"
                                                            style="transform: translate(-30%, 0px); z-index: 4;">
                                                            <div class="noUi-handle noUi-handle-upper" data-handle="1"
                                                                tabindex="0" role="slider" aria-orientation="horizontal"
                                                                aria-valuemin="30.0" aria-valuemax="100.0"
                                                                aria-valuenow="70.0" aria-valuetext="700.00"></div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="widget-body">
                                    <div class="owl-carousel widget-featured-products owl-loaded owl-drag">
                                        ...
                                        <div class="owl-stage-outer owl-height" style="height: 254px;">
                                            <div class="owl-stage"
                                                style="transform: translate3d(-684px, 0px, 0px); transition: 0.25s; width: 1368px;">
                                        ...
                                        <div class="owl-nav"><button type="button" role="presentation"
                                                class="owl-prev"><i class="icon-angle-left"></i></button><button
                        ...
                        <div class="col-6 col-md-3">
                            <div class="product">
                                <figure class="product-image-container">
                                    ...
                                    <a href="#" class="btn-quickview">Quickview</a>
                                </figure>
                                <div class="product-details">
                                    <div class="ratings-container">
                                        <div class="product-ratings">
                                    ...
                                    <div class="product-action">
                                        <a href="#" class="paction add-wishlist" title="Add to Wishlist">
                                            BRANDS <span>Add to Wishlist</span>
                                        </a>
