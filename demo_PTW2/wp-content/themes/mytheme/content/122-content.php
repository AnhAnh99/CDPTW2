            ...
            <div class="row row-sm category-grid">
                    ...
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-1-white.jpg" alt="product">
                            </a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-2-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-3-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-4-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-5-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-6-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-7-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                            <span class="product-label label-hot">Hot</span>
                        </figure>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-8-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-9-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-10-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-11-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                        </figure>
                        <div class="product-details">
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="grid-product">
                        <figure class="product-image-container">
                            <a href="product.html" class="product-image">
                                <img src="images/products/product-12-white.jpg" alt="product">
                            </a>
                            <a href="ajax/product-quick-view.html" class="btn-quickview">Quickview</a>
                            <span class="product-label label-hot">Hot</span>
                        </figure>
